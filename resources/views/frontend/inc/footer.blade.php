...
<section class="py-5 text-light footer-widget" style="background:#132a12">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4">
                <div class="text-center text-md-left mt-4">
                    <h4 class="fs-13 text-uppercase fw-600 border-bottom border-gray-800 pb-2 mb-4">
...
<!-- FOOTER -->
<footer class="pt-4 pb-8 pb-xl-4 text-light" style="background:#081208">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-12">
                <div class="text-center" current-verison="{{get_setting("current_version")}}" style="color:#399735; letter-spacing:0.5px">
